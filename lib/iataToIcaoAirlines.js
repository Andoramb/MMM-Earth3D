// IATA (2-letter) -> ICAO (3-letter) airline code lookup, so flightTracker.js can turn "UA123" into OpenSky's callsign form "UAL123". Major carriers only, not exhaustive.
module.exports = {
